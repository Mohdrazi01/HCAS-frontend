...
import { AuthRequest as ApSystemModelsAuthAuthRequest } from './Service1Models/auth-request';
import { AuthResponse as ApSystemModelsAuthAuthResponse } from './Service1Models/auth-response';
import { EmailConfirmationResponse as ApSystemModelsAuthEmailConfirmationResponse } from './Service1Models/email-confirmation-response';
import { GenderResponse as ApSystemModelsAuthGenderResponse } from './Service1Models/gender-response';
import { RegisterUserRequest as ApSystemModelsAuthRegisterUserRequest } from './Service1Models/register-user-request';
import { RegisterUserResponse as ApSystemModelsAuthRegisterUserResponse } from './Service1Models/register-user-response';
import { RoleResponse as ApSystemModelsAuthRoleResponse } from './Service1Models/role-response';
import { UserDetailsRequest as ApSystemModelsAuthUserDetailsRequest } from './Service1Models/user-details-request';
import { UserDetailsResponse as ApSystemModelsAuthUserDetailsResponse } from './Service1Models/user-details-response';
